                        ...
                        <div className="row">
                            <div className="col-lg-6">
                                <div className="about-us">
                                    <h2>About Us</h2>
                                    <h5>Jumping on your day.</h5>
                                    <p>{general.about_text}</p>
                                    <p><a href="#" className="btn btn-custom btn-custom-small">LEARN MORE</a></p>
                                </div>
                            </div>
                            <div className="col-lg-6">
                                <figure className="about-pic"><img src={'http://127.0.0.1:8000/photo/'+general.about_photo} alt="" /></figure>
                            </div>
                        </div>
                    </div>
