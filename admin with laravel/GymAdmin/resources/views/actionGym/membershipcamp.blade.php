            ...
            <div class="col-xl-12 col-lg-12">
                <div class="card mb-3">
                    ...
                    <div class="card-body">
                        ...
                        <form action="{{route('membershipcampUpdate',$ms->id)}}" method="post" enctype="multipart/form-data">
                            @csrf
                            @method('put')
                            <table class="table table-bordered">
                                <tr>
                                    <th>Title</th>
                                    <td>
                                        <input type="text" name="title" class="form-control" value="{{$ms->title}}">
                                           
                                    </td>
                                    <td>Photo</td>
                                    <td>
                                        <input type="file" name="photo" class="form-control">
                                        <img src="{{url('photo/'.$ms->photo)}}" alt="" width="100px">
                                    </td>
                                </tr>
                                ...
                                <tr>
                                    <th>Description</th>
                                    <td colspan="3">
                                        <textarea name="description" id="" cols="15" rows="5" class="form-control">{{$ms->description}}</textarea>
