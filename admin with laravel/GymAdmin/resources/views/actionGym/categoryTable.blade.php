        ...
        <div class="col-xl-12 col-lg-12">
            <div class="card mb-3">
                ...
                <div class="card-body">
                    ...
                    <a href="{{route('categoryForm')}}" class="btn">Add Category</a>
                        ...
                        <tbody>
                            @foreach ($category as $key=>$data)
                                <tr>
                                    ...
                                    <td>
                                        <img src="{{url('photo/category/icon/'.$data->icon)}}" alt="" width="70px">
                                    </td>
                                    <td>
                                        <img src="{{url('photo/category/'.$data->photo)}}" alt="" width="100px">
                                        {{-- {{$data->photo}} --}}
                                    </td>
                                    <td>
                                        <a href="{{route('editCategory',$data->id)}}" class="btn " style="color:greenyellow"><i class="fas fa-edit"></i></a>
