        ...
        <div class="login-content">
            <form method="POST" action="{{ route('login') }}" name="login_form">
                ...
                <div class="mb-3">
                    ...
                    <input type="text" class="form-control form-control-lg bg-white bg-opacity-5 @error('email') is-invalid @enderror" name="email" value="{{ old('email') }}" placeholder="Enter Your Email" />
                    @error('email')
                ...
                <div class="mb-3">
                    ...
                    <input type="password" class="form-control form-control-lg bg-white bg-opacity-5 @error('password') is-invalid @enderror" name="password" required autocomplete="current-password" />
                    @error('password')
                    <span class="invalid-feedback" role="alert">
                        <strong>{{ $message }}</strong>
                    </span>
