    ...
    <div class="row">
        ...
        <div class="col-xl-12 col-lg-12">
            <div class="card mb-3">
                ...
                <div class="card-body">
                    <h1>Package table</h1>
                    <a href="{{route('packageForm')}}" class="btn">Add Package</a>
                        ...
                        <tbody>
                            @foreach ($package as $key=>$data)
                                <tr>
                                    ...
                                    <td>
                                       @php
                                           $d = json_decode($data->description)
                                    ...
                                    <td>
                                        <a href="{{route('editPackage',$data->id)}}" class="btn " style="color:greenyellow"><i class="fas fa-edit"></i></a>
                                        <form action="{{route('deletePackage',$data->id)}}" method="POST"  >
                                            @csrf
                                            @method('delete')
