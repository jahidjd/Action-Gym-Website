    ...
    <div class="row">
        ...
        <div class="col-xl-12 col-lg-12">
            <div class="card mb-3">
                ...
                <div class="card-body">
                    <h1>Slider table</h1>
                    <a href="{{route('sliderForm')}}" class="btn">Add Slider</a>
                        ...
                        <tbody>
                            @foreach ($slider as $key=>$data)
                                <tr>
                                    ...
                                    <td>
                                        <img src="{{url('photo/slider/'.$data->photo)}}" alt="" width="100px">
                                        {{-- {{$data->photo}} --}}
                                    </td>
                                    <td>
                                        <a href="{{route('editSlider',$data->id)}}" class="btn " style="color:greenyellow"><i class="fas fa-edit"></i></a>
                                        <form action="{{route('deleteSlider',$data->id)}}" method="POST"  >
                                            @csrf
                                            @method('delete')
