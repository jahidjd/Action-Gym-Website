        ...
        <div class="row">
            ...
            <div class="col-xl-12 col-lg-12">
                <div class="card mb-3">
                    ...
                    <div class="card-body">
                        <h1>Add Slider</h1>
                        <a href="{{route('sliderTable')}}" class="btn">Slider List</a>
                        <form action="{{route('insertSlider')}}" method="post" enctype="multipart/form-data">
                            ...
                            <table class="table table-bordered">
                                <tr>
                                    ...
                                    <th>Small Text</th>
                                    <td>
                                        <input type="text" name="small_text" class="form-control" value="{{old('small_text')}}">
                                        @error('small_text')
                                        <span style="color: red">{{$message}}</span>
                                    @enderror
                                    </td>
                                ...
                                <tr>
                                    <th>Big Text</th>
                                    <td colspan="3">
                                        <textarea name="big_text" id="" cols="10" rows="3" class="form-control">{{old('big_text')}}</textarea>
                                        @error('big_text')
                                        <span style="color: red">{{$message}}</span>
                                        @enderror
                                    </td>
