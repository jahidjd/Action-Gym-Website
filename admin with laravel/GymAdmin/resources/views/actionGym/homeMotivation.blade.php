        ...
        <div class="row">
            ...
            <div class="col-xl-12 col-lg-12">
                <div class="card mb-3">
                    ...
                    <div class="card-body">
                        <h1>Update Home Motivation</h1>
                       
                        <form action="{{route('homeMotivationUpdate',$hm->id)}}" method="post" enctype="multipart/form-data">
                            @csrf
                            @method('put')
                            <table class="table table-bordered">
                                <tr>
                                    <th>Title</th>
                                    <td>
                                        <input type="text" name="title" class="form-control" value="{{$hm->title}}">
                                           
                                    </td>
                                    <th>Total Staff</th>
                                    <td>
                                        <input type="text" name="total_staff" class="form-control" value="{{$hm->total_staff}}">
                                        
                                    </td>
                                </tr>
                                <tr>
                                    <td>Calories Burn</td>
                                    <td><input type="text" name="calories_burn" class="form-control" value="{{$hm->calories_burn}}"></td>
                                    <td>Happy Customer</td>
                                    <td><input type="text" name="happy_customer" class="form-control" value="{{$hm->happy_customer}}"></td>
                                </tr>
                                <tr>
                                    <th>Description</th>
                                    <td colspan="3">
                                        <textarea name="description" id="" cols="15" rows="5" class="form-control">{{$hm->description}}</textarea>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        <img src="{{url('photo/'.$hm->photo)}}" alt="" width="100px">
                                    </td>
