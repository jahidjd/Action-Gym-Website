    ...
    <div class="row">
        ...
        <div class="col-xl-12 col-lg-12">
            <div class="card mb-3">
                ...
                <div class="card-body">
                    <h1>Class table</h1>
                    <a href="{{route('classessForm')}}" class="btn">Add Class</a>
                        ...
                        <tbody>
                            @foreach ($class as $key=>$data)
                                <tr>
                                    ...
                                    <td>{{$data->title}}</td>
                                    <td>
                                        <img src="{{url('photo/classess/icon/'.$data->icon)}}" alt="" width="100px">
                                        {{-- {{$data->photo}} --}}
                                    </td>
                                    <td>
                                        <img src="{{url('photo/classess/'.$data->photo)}}" alt="" width="180px">
                                        {{-- {{$data->photo}} --}}
                                    </td>
                                    <td>
                                        <a href="{{route('editClass',$data->id)}}" class="btn " style="color:greenyellow"><i class="fas fa-edit"></i></a>
                                        <form action="{{route('deleteClasses',$data->id)}}" method="POST"  >
                                            @csrf
                                            @method('delete')
                                            <button type="submit" class="btn " style="color: red" onclick="return confirm('are your sure!')"><i class="fas fa-trash"></i></button>
                                        </form>
