                            ...
                            <table class="table table-bordered">
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        <img src="{{url('photo/slider/'.$slider->photo)}}" alt="" width="100px"> 
                                    </td>
                                    <th>Small Text</th>
                                    <td>
                                        <input type="text" name="small_text" class="form-control" value="{{$slider->small_text}}">
                                ...
                                <tr>
                                    <th>Big Text</th>
                                    <td colspan="3">
                                        <textarea name="big_text" id="" cols="10" rows="3" class="form-control">{{$slider->big_text}}</textarea>
