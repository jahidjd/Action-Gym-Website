                        ...
                        <form action="{{route('updatePackage',$package->id)}}" method="post" enctype="multipart/form-data">
                            ...
                            <table class="table table-bordered">
                                <tr>
                                    ...
                                    <th>Price</th>
                                    <td>
                                        <input type="text" name="rate" class="form-control" value="{{$package->rate}}">
                                ...
                                <tr>
                                    ...
                                    <td colspan="2">
                                        @php
                                        $d = json_decode($package->description);
                                        $sl =0;
                                        @endphp
                                        ...
                                        <div class='cl_{{$sl}}'>
                                            ...
                                            <div class='col-xl-5 col-md-5'>
                                                <input type='text' class='form-control remove_{{$sl}}' name='key[]' value='{{$item}}'>
                                            </div>
                                            
                                            <div col-xl-2 col-md-2>
                                              
                                                <a class='btn remove' value='{{$sl}}'   style="color:red">X</a>
                                            </div>
                                        </div>
                                        @endforeach
                                    ...
                                    <td>
                                        <p class="btn" style="color: yellowgreen" id="add">+</p>
...
<script>
    $(document).ready(function() {
        ...
        $('#add').on('click', function() {
            c++
            let tr = "<div class='cl_" + c + "'><td>Description</td><td colspan='2'><input type='text' name='description[]' class='form-control number_" + c + "'' placeholder='add description'></td><td><p class='btn remove' value='" + c + "' style='color:red' '>-</p></td></tr>"
            $('.new').append(tr)

        })
        $(document).on('click', '.remove', function() {
            let remove = $(this).attr('value')
            $('.cl_' + remove).remove();
