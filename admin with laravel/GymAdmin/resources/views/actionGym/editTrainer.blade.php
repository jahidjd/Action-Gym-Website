        ...
        <div class="row">
            ...
            <div class="col-xl-12 col-lg-12">
                <div class="card mb-3">
                    ...
                    <div class="card-body">
                        <h1>Add Trainer</h1>
                        <a href="" class="btn">Trainer List</a>
                        <form action="{{route('updateTrainer',$trainer->id)}}" method="post" enctype="multipart/form-data">
                            @csrf
                            @method('put')
                            <table class="table table-bordered">
                                <tr>
                                    ...
                                    <th>Trainer Type</th>
                                    <td>
                                        <input type="text" name="trainer_type" class="form-control" value="{{$trainer->trainer_type}}">
                                ...
                                <tr>
                                    <th>Description</th>
                                    <td colspan="3">
                                        <textarea name="description" id="" cols="15" rows="5" class="form-control">{{$trainer->description}}</textarea>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        <img src="{{url('photo/trainer/'.$trainer->photo)}}" alt="" width="100px">
                                    </td>
