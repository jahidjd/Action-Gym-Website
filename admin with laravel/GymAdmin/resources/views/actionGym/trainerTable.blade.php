    ...
    <div class="row">
        ...
        <div class="col-xl-12 col-lg-12">
            <div class="card mb-3">
                ...
                <div class="card-body">
                    <h1>Trainer table</h1>
                    <a href="{{route('trainer')}}" class="btn">Add Trainer</a>
                        ...
                        <tbody>
                            @foreach ($trainer as $key=>$data)
                                <tr>
                                    ...
                                    <td>
                                        <img src="{{url('photo/trainer/'.$data->photo)}}" alt="" width="100px">
                                        {{-- {{$data->photo}} --}}
                                    </td>
                                    <td>
                                        <a href="{{route('editTrainer',$data->id)}}" class="btn " style="color:greenyellow"><i class="fas fa-edit"></i></a>
                                        <form action="{{route('deleteTrainer',$data->id)}}" method="POST"  >
                                            @csrf
                                            @method('delete')
