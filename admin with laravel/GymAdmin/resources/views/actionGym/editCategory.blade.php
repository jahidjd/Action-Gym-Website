                            ...
                            <table class="table table-bordered">
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        <img src="{{url('photo/category/icon/'.$category->icon)}}" alt="" width="100px">
                                    </td>
                                </tr>
                                <tr>
                                    <th>Description</th>
                                    <td colspan="3">
                                        <textarea name="description" id="" cols="15" rows="5" class="form-control">{{$category->description}}</textarea>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        <img src="{{url('photo/category/'.$category->photo)}}" alt="" width="100px">
                                    </td>
